...
public class QueryJoin implements Literal {
    ...
    public boolean isInRelationSet(Set<Relation> relationSet) {
        Set<RelationAttribute> relationAttributeSet = new HashSet<RelationAttribute>();
        for (Relation relation : relationSet) {
            relationAttributeSet.addAll(relation.getAttributesSet());
        }
        return relationAttributeSet.containsAll(this.getRelations());
    }

    public Set<RelationAttribute> getRelations() {
        Set<RelationAttribute> relationAttributes = new HashSet<RelationAttribute>();
        relationAttributes.add(termLeft);
        relationAttributes.add(termRight);
